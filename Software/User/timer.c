...
void TIM3_Pwm_Init(u32 arr,u32 psc)
{
    ...
    RCC_APB1PeriphClockCmd(RCC_APB1Periph_TIM3,ENABLE);//TIM 时钟使能
    RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOB, ENABLE); //使能 PORTB 时钟

    GPIO_PinAFConfig(GPIOB,GPIO_PinSource5,GPIO_AF_TIM3); //PB7 复用为 TIM
    ...
    TIM_OC2Init(TIM3, &TIM_OCInitStructure); //初始化外设 TIM OC1
